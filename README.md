...
- 🔌 **[pi2omp](https://github.com/sasha-computer/pi2omp)** -- Run Pi packages in OMP without changing a single line of code. Re-export shims + npm aliases.
...
- ⌨️ **[tmux-config](https://github.com/sasha-computer/tmux-config)** -- Hyper-key driven tmux config for Ghostty on macOS. Extended keys, popup cheat sheet, Catppuccin theme.
...
- 🗺️ **[japan-trip](https://github.com/sasha-computer/2026/tree/main/japan-trip)** -- 16-day Japan trip planner with interactive map, budget tracker, and drag-and-drop planner.
...
- 🌐 **[browser-verifier](https://github.com/sasha-computer/2025/tree/main/browser-verifier)** -- ZK proof verification running entirely in the browser via WASM.
...
- 🧠 **[nn](https://github.com/sasha-computer/2025/tree/main/nn)** -- Neural networks from scratch. Backprop, gradient descent, tinygrad, all by hand following Karpathy.
